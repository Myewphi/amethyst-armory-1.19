...
public class ModItems {
    ...
    public static final Item AMETHYST_SHOVEL = registerItem("amethyst_shovel",
            new ShovelItem(AmethystToolMaterial.INSTANCE, 1.5f, 1f, new FabricItemSettings()), ModItemGroup.TUTORIALTAB);
    public static final Item AMETHYST_PICKAXE = registerItem("amethyst_pickaxe",
            new PickaxeItem(AmethystToolMaterial.INSTANCE, 1, 1f, new FabricItemSettings()), ModItemGroup.TUTORIALTAB);
    public static final Item AMETHYST_AXE = registerItem("amethyst_axe",
            new AxeItem(AmethystToolMaterial.INSTANCE, 5, 1f, new FabricItemSettings()), ModItemGroup.TUTORIALTAB);
    public static final Item AMETHYST_HOE = registerItem("amethyst_hoe",
            new CustomHoeItem(AmethystToolMaterial.INSTANCE, -3, 1f, new FabricItemSettings()), ModItemGroup.TUTORIALTAB);
    public static final Item AMETHYST_SWORD = registerItem("amethyst_sword",
            new SwordItem(AmethystToolMaterial.INSTANCE, 3, 1f, new FabricItemSettings()), ModItemGroup.TUTORIALTAB);
